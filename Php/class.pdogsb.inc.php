...
class PdoGsb {
    ...
    private static $serveur = 'mysql:host=db776059279.hosting-data.io';
    private static $bdd = 'dbname=db776059279';
    private static $user = 'dbo776059279';
    private static $mdp = '29mars1991';
